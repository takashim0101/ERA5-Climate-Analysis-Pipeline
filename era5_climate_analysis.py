...
# temp_wind_files = glob.glob("downloaded_data/era5_2024_temp_wind.nc")
# precip_files = glob.glob("downloaded_data/era5_2024_precip.nc")
# 
...
# 
# monthly_mean = canterbury_speed.groupby('valid_time.month').mean().compute()
...
# 
# # !!! This line MUST plot the 12-month averaged data (12 bars) !!!
...
# # This correctly sets the 12 labels for the 12 bars
...
# 
# # !!! CRITICAL FIX: Use plt.show() to open the plot window in VS Code/script environment. !!!
# # plt.close() # <-- Remove or comment this line out
